      ...
      <Layout header={false}>
                ...
                <div className="col-lg-8">
                  <div className="about__text section__text">
                    <p>
                      ...
                      can exercise your rights in one step via the “Global
                      Privacy Control” (GPC) signal, which is required under the
            ...
            <div className="row">
              <div className="col-12 col-lg-5">
                <p className="section__title">
                  The Global Privacy Control (GPC) specification describes how
                  to implement a browser mechanism to help users signal their
                  desired privacy to websites and services.
                </p>
                <p className="section__text">
                  Right now the GPC signal is not a finalized standard, but it
                  is already available to users as part of several major
                  browsers and extensions and is respected by several major
                  websites (see below). The GPC signal will be intended to
                  communicate a Do Not Sell request from a global privacy
                  control, as per
                  <a
        ...
        <section id="orgs" className="orgs section">
          <div className="container">
            <div className="row">
              <div className="col-12 col-lg -5">
                <p className="section__title">Participating Organizations</p>
                <p className="section__text">
            ...
            <div className="row">
              <div className="col-12 col-lg-5">
                <div>
                  ...
                  <p className="section__text">
                    Download one of these participating browsers or extensions
                    to communicate your Global Privacy Preferences to
